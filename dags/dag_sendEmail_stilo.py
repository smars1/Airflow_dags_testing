...
def send_failure_email(context):
    ...
    html_content = f"""
        <div style="font-family: Arial, sans-serif; color: #333;">
            <h2 style="color: #FF4B4B;">Task Failure Notification</h2>
            <p style="color: #017CEE;"><strong>DAG:</strong> {dag_id}</p>
            <p style="color: #017CEE;"><strong>Task:</strong> {task_id}</p>
            <p style="color: #017CEE;"><strong>Execution Date:</strong> {execution_date}</p>
            <p>View the log: <a href="{log_url}" style="color: #2EB67D;">Log URL</a></p>
